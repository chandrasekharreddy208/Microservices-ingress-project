pipeline {
    ...
    environment {
        DOCKER_HUB_REPO = 'kubemcchandureddy/techsolutions-app'
        K8S_CLUSTER_NAME = 'chandro-cluster'
    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/chandrasekharreddy208/Microservices-ingress-project.git'
            }
        }
